...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s buttcoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  buttcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded buttcoin transaction") + "\n" +
              "  buttcoin-tx [options] -create [commands]   " + _("Create hex-encoded buttcoin transaction") + "\n" +
              "\n";
