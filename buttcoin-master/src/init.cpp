...
#ifndef WIN32
    strUsage += HelpMessageOpt("-pid=<file>", strprintf(_("Specify pid file (default: %s)"), buttcoin_PID_FILENAME));
#endif
...
std::string LicenseInfo()
{
    ...
    const std::string URL_WEBSITE = "<https://buttcoincore.org>";
...
bool AppInitMain(boost::thread_group& threadGroup, CScheduler& scheduler)
{
    ...
    LogPrintf("Using config file %s\n", GetConfigFile(gArgs.GetArg("-conf", buttcoin_CONF_FILENAME)).string());
