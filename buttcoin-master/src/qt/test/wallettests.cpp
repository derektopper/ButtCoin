...
uint256 SendCoins(CWallet& wallet, SendCoinsDialog& sendCoinsDialog, const CTxDestination& address, CAmount amount, bool rbf)
{
    ...
    entry->findChild<buttcoinAmountField*>("payAmount")->setValue(amount);
...
//
//     src/qt/test/test_buttcoin-qt -platform xcb      # Linux
//     src/qt/test/test_buttcoin-qt -platform windows  # Windows
//     src/qt/test/test_buttcoin-qt -platform cocoa    # macOS
void TestGUI()
{
    ...
    QString balanceComparison = buttcoinUnits::formatWithUnit(unit, balance, false, buttcoinUnits::separatorAlways);
    ...
    // Amount input
    buttcoinAmountField* amountInput = receiveCoinsDialog.findChild<buttcoinAmountField*>("reqAmount");
    ...
    for (QWidget* widget : QApplication::topLevelWidgets()) {
        if (widget->inherits("ReceiveRequestDialog")) {
            ...
            QVERIFY(paymentTextList.at(1).indexOf(QString("URI: buttcoin:")) != -1);
