...
This document provides guidelines for internationalization of the buttcoin Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `buttcoin_en.ts` remains unchanged.
