buttcoin Core version 0.9.4 is now available from:

  https://buttcoin.org/bin/0.9.4/
...
this update is incompatible with the buttcoin system and could lead to consensus
forks.

buttcoin Core released binaries from https://buttcoin.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~buttcoin/+archive/ubuntu/buttcoin
- A third-party or self-compiled buttcoin Core

upgrade to buttcoin Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
