buttcoin Core version 0.13.2 is now available from:

  <https://buttcoin.org/bin/buttcoin-core-0.13.2/>
...
- #8908 `4a974b2` Update buttcoin-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow buttcoin-tx to create v2 transactions (btcdrak)
