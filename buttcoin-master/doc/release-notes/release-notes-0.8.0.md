buttcoin-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/buttcoin/files/buttcoin/buttcoin-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the buttcoin
...
New/changed settings (command-line or buttcoin.conf file)
--------------------------------------------------------
