...
* buttcoin.conf: contains configuration settings for buttcoind or buttcoin-qt
* buttcoind.pid: stores the process id of buttcoind while running
...
* debug.log: contains debug information and general logging generated by buttcoind or buttcoin-qt
