...
buttcoin Core version *version* is now available from:

  <https://buttcoin.org/bin/buttcoin-core-*version*/>
...
GCC 4.8.x
--------------
The minimum version of GCC required to compile buttcoin Core is now 4.8. No effort will be
