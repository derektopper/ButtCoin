...
Also test that nodes that send unsupported service bits to buttcoind are disconnected
...
class CNodeNoVersionBan(CLazyNode):
    ...
    # NOTE: implementation-specific check here. Remove if buttcoind ban behavior changes
    def on_open(self):
        super().on_open()
