#!/usr/bin/env python3
# Copyright (c) 2015-2016 The buttcoin Core developers
# Distributed under the MIT software license, see the accompanying
# file COPYING or http://www.opensource.org/licenses/mit-license.php.
"""Test block processing.

This reimplements tests from the buttcoinj/FullBlockTestGenerator used
by the pull-tester.
...
class FullBlockTest(ComparisonTestFramework):
    ...
    def get_tests(self):
        ...
        # Extend the b26 chain to make sure buttcoind isn't accepting b26
        ...
        # Extend the b28 chain to make sure buttcoind isn't accepting b28
        ...
        #    Low-S and High-S values (whereas the buttcoin code has custom code which does so);
